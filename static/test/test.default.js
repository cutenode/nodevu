...
function check (data) {
  ...
  assert.deepStrictEqual(data.v16.releases['v16.19.0'].dependencies.npm, '8.19.3')
  assert.deepStrictEqual(data.v16.releases['v16.19.0'].files.available.length, 19)
  assert.deepStrictEqual(data.v16.releases['v16.19.0'].files.links.macos[0].files[0], 'node-v16.19.0-darwin-arm64.tar.gz')
