...
exports.handler = function (argv) {
  request(api.data, function(error, response, body) {
    ...
    const versionToCheck = argv.version === undefined ? process.version : semver.clean(argv.version) // use the passed version if there is one, but otherwise default to the system's current version.
